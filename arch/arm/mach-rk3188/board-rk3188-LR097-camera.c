...
Simple camera device registration:
       ...
       new_camera_device_rk(sensor_name,\        // sensor name, it is equal to CONFIG_SENSOR_X
                          face,\              // sensor face information, it can be back or front
...
static struct rkcamera_platform_data new_camera[] = { 
    ...
    new_camera_device_rk(RK29_CAM_SENSOR_GC2035,
                        back,
                        BACK_ORI,
                        RK30_PIN3_PB5,
                        0,
    ...
    new_camera_device_rk(RK29_CAM_SENSOR_GC0308,
                        front,
                        FRONT_ORI,
                        RK30_PIN3_PB4,
                        0,
    ...
    new_camera_device_rk(RK29_CAM_SENSOR_GC0329,
                        front,
                        FRONT_ORI,
                        RK30_PIN3_PB4,
                        0,
